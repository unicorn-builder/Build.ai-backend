...
STRINGS = {
    'fr': {
        ...
        'main_benefits':    'Avantages principaux',
        'star_recommended': '★ Recommandé',
        'options_note':     "ℹ Si plusieurs options ont des impacts prix significatifs, les soumettre au maître d\'ouvrage avant validation.",
        'total_partitions': 'Surface totale cloisons estimée',
        'separating':       'séparatives',
        'lightweight':      'légères',
        'ducts':            'gaines',
        'recommended_option': 'Option recommandée',
        'retained_load':    'charge retenue',
        'estimated':        'estimés',
        'of_struct_budget': 'du budget structure',
        'levels':           'niveaux',
        # Footer disclaimer
        'disclaimer':   (
    ...
    'en': {
        ...
        'main_benefits':    'Key benefits',
        'star_recommended': '★ Recommended',
        'options_note':     'ℹ If several options have significant cost impacts, present them to the project owner for validation.',
        'total_partitions': 'Total estimated partition area',
        'separating':       'separating',
        'lightweight':      'lightweight',
        'ducts':            'ducts',
        'recommended_option': 'Recommended option',
        'retained_load':    'retained load',
        'estimated':        'estimated',
        'of_struct_budget': 'of structure budget',
        'levels':           'levels',
        # Footer disclaimer
        'disclaimer':   (
